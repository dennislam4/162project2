...
class LemonadeStand:
    """
    Represents a lemonade stand displaying the store title, the current day, menu items for sale for the day alongside
    their sales.
    """
    ...
    def total_sales_for_menu_item(self, day, item_name):
        """
        Returns the total number of times an item has been sold for the entirety of however long the lemonade stand has
        been open.
        """
    ...
    def total_profit_for_menu_item(self, day, item_name):
        """
        Returns the total profit of menu item sold for the entirety of however long the lemonade stand has been open.
        """
    ...
    def total_profit_for_stand(self, day, item_name):
        """
        Returns the total profit on all items sold over the entirety of however long the lemonade stand has been open.
        """
        profit_on_all_items = 0
        for days in range(self._current_day):
            profit_on_all_items += self.total_profit_for_menu_item(day, item_name)
...
def main():
    ...
    print(stand.total_profit_for_stand(0, "lemonade"))
